...
import VirginiaIcon from '@/components/icons/VirginiaIcon'
import { FEATURED_COLLECTIONS, SITE_URL } from '@/lib/constants'

const COLLECTION_SLUG = 'virginia-dc'
...
export default async function VirginiaJobsPage() {
  const collection = getCollection()
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col-reverse sm:flex-row items-start justify-between gap-4 sm:gap-6 mt-3 mb-8">
          ...
          <VirginiaIcon size={88} className="text-black flex-shrink-0" />
        </div>
